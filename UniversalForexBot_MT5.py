        ...
        try:
            ...
            while self.is_running:
                ...
                try:
                    ...
                    self.log(f"V8.4 SIGNAL={signal} | Mode={signal_mode} | BUY_W/SELL_W={buy_score}/{sell_score} | {decision_reason}")
                    if signal_mode == "ADAPTIVE_EVIDENCE":
                        try:
...
# ============================================================
# V8.4.2-R5 FOREX PRODUCTION OVERRIDES
# Self-contained: no dependency on a historical V8.4.0 source file.
# ============================================================
...
_orig_pre=GUI._validate_strategy_preflight; _orig_prot=fx_v2_calculate_protection_prices; _orig_start=GUI.start_bot
