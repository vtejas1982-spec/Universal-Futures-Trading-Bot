...
APP_VERSION = "V8.2.6"
APP_TITLE = "Universal Futures Trading Bot V8.2.6 - Multi-Exchange (No KuCoin)"
...
# V8.2.6 advanced strategy defaults
...
class UniversalFuturesBotGUI:
    ...
    def __init__(self, root):
        ...
        # V8.2.6 Volume S/R higher-timeframe cache. Higher-TF data is
        ...
        try:
            ...
            while self.is_running:
                ...
                try:
                    ...
                    # V8.2.6 Divergence module. All calculations are causal:
                    ...
                    # V8.2.6 Divergence directional module.
                    if use_divergence:
                    ...
                    # V8.2.6 Volume-based Support/Resistance Zones.
                    if use_vol_sr:
                        directional_modules.append(
                    ...
                    self.log(
                        ...
                        f"Confirmations={'OFF' if signal_mode in ('SINGLE_SIGNAL','ANY_NON_CONFLICTING','2_SIGNALS','3_SIGNALS','4_SIGNALS','SCORE') else 'ON'} "
