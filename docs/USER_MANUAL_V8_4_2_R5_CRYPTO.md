# CRYPTO FUTURES EDITION — V8.4.2-R5

Primary focus: Crypto Futures live engine. This file is nevertheless a complete reference for Crypto, Forex/MT5 and both backtesters.
